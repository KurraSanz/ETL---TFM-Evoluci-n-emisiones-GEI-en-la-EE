'''
Script de estandarización y creación de tablas de hechos y dimensiones
-----------------------------------------------------------------------
...
3. **Organización en capas del modelo de datos:**
...
for carpeta in [CARPETA_ESTANDARIZADOS, CARPETA_FACT, CARPETA_DIM]:
...
for archivo in tqdm(archivos_curados_eea, desc="Procesando archivos curados"):
...
#Mover los ficheros de CARPETA_CURADO_EUROSTAT a CARPETA_ESTANDARIZADOS
...
#2) CREACIÓN TABLAS DE DIMENSIONES Y HECHOS
